 ...
 * @link https://github.com/Rundiz/nested-set Download
 * @author Vee W.
 */
class NestedSet
{
    ...
    protected function getTreeRebuildChildren(array $array): array
    {
        foreach ($array as $id => $row) {
            if (array_key_exists($this->parentIdColumnName, (array) $row)) {
    ...
    public function rebuild(array $where = [])
    {
        ...
        $this->rebuildGenerateTreeData($data, '', 0, $n);
     ...
     */
    protected function rebuildGenerateTreeData(array &$array, $id, int $level, int &$n)
    {
